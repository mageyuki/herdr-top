    ...
    fn i4_help_renders_and_refreshes_complete_runtime_diagnostics() {
        ...
        let complete = RuntimeDiagnosticsSnapshot {
            ...
            controller_counters: ControllerCounterSnapshot {
                ...
                unknown_lane_terminal_drops: 20,
        ...
        for expected in [
            ...
            "controller counters: binding_conflicts=11 terminal_blocked_progress_noops=12 terminal_forward_reference_creations=13 unknown_lane_terminal_drops=20",
