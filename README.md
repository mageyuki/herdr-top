...
│ │       └── Pane: w1:p2                                                                                                          │
│ │           └── Codex tests [model:gpt-safe] [blocked] · 03m14s [dispatched by: controller]                                      │
│ └── Workspace: docs                                                                                                              │
│     └── Tab: review                                                                                                              │
│         └── Pane: w2:p1                                                                                                          │
...
│ Selected: Codex tests [model:gpt-safe] [blocked] · 03m14s [dispatched by: controller]                                            │
│ selection: stable                                                                                                                │
│ Newest: at=1723456789012 kind=agent_activity source_type=item provider=Codex durability=durable model=gpt-safe tool=Read         │
├──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
...
The upcoming v0.1.0 release contains these archives:

| Platform | Release target | v0.1.0 archive | Methods |
| --- | --- | --- | --- |
| macOS, Apple silicon | `aarch64-apple-darwin` | `herdr-top-0.1.0-aarch64-apple-darwin.tar.gz` | Installer, release archive, Herdr plugin |
| macOS, Intel | `x86_64-apple-darwin` | `herdr-top-0.1.0-x86_64-apple-darwin.tar.gz` | Installer, release archive, Herdr plugin |
| Linux, x86-64 | `x86_64-unknown-linux-gnu` | `herdr-top-0.1.0-x86_64-unknown-linux-gnu.tar.gz` | Installer, release archive, Herdr plugin |
| Linux, ARM64 | `aarch64-unknown-linux-gnu` | `herdr-top-0.1.0-aarch64-unknown-linux-gnu.tar.gz` | Installer, release archive, Herdr plugin |
...
- [Internal process documents](docs/internal/superpowers/)
